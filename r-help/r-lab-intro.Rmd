...
You might need to Google or maybe you asked for help to your friends/mentor and they find out you’ve forgot a closing bracket!.
...
???
Scanning your code for x’s before running it is always a good idea and it’s very convenient since you know exactly on which line you made a mistake. 
...
Although the error messages look scary (the red font and words like “fatal” sure give them a bad reputation), they are actually the second best option to no errors at all: R has identified there is a problem and from the message, you can figure out what it is and solve it!
...
#### Phone a friend (or team member) ☎️ 
